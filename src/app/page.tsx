...
<li className="px-4 py-2">And a sixth one</li>        </ul>
      </div>

      {/* Newsletter Signup Section */}
      <div className="mb-6 p-6 bg-green-50 dark:bg-green-900/20 rounded-xl shadow">
    ...
    <form onSubmit={handleSubmit} className="max-w-md mx-auto space-y-4">
      <div className="flex flex-col sm:flex-row gap-3">
        <input
          ...
          className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white"
        />
        <input
          type="email"
          value={email}
